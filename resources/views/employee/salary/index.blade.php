...
<div class="container mt-4">
    ...
    <form method="GET" class="mb-3 row g-2">
        ...
        <div class="col-md-3">
            <button type="submit" class="btn-primary btn btn-outline-light">Lihat</button>
        </div>
    </form>
    @if(session('error'))
    ...
    <a href="{{ route('salary.download', auth()->user()->id) }}" class="btn-primary btn btn-outline-light mt-3">⬇️ Unduh Slip Gaji PDF</a>
</div>
@endsection
