...
<div class="container py-4">
    ...
    <!-- Tombol Presensi -->
    @if ($hasCheckInToday)
        <button class="btn-primary btn btn-outline-light" disabled >Kamu Sudah Absen</button>
    @else
        <form action="{{ route('attendance.store') }}" method="POST">
            @csrf
            <button type="submit" class="btn-primary btn btn-outline-light">Absen Sekarang</button>
        </form>
    @endif
